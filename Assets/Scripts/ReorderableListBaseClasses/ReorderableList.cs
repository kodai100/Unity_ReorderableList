...
namespace ProjectBlue.ReorderableLists
{
    ...
    public abstract class ReorderableList<T, U> : MonoBehaviour where T : ReorderableListComponent<U>
    {
        ...
        {
            var listComponent = Instantiate(prefab, scrollViewContentTransform);
